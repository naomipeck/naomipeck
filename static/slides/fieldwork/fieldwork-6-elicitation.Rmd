...
>####*... elicitation is the general term for describing various methods of directed data collention and thus for corpus construction.*
>
> (Senft 1995:105)
...
.center[
```{r out.width="70%", out.height="70%", echo=FALSE, label="Frame sentences in Burmese used in Chirkova et al. 2019", fig.alt="Frame sentences in Burmese used for elicitation in Chirkova et al. 2019 (Chirkova et al. 2019:29)."}
knitr::include_graphics("./chirkova-frame.png")
```
]

???

Figure: Frame sentences in Burmese used for elicitation in Chirkova et al. 2019 (Chirkova et al. 2019:29).

Chirkova, Katia, Patricia Basset, and Angélique Amelot. 2019. Voiceless nasal sounds in three Tibeto-Burman languages. *Journal of the International Phonetic Association* 49(1), 1-32.
...
It is also possible to use the translation technique to get some initial insights into linguistic structures. This could involve testing phonotactics or grammatical structures. <br><br>

**Phonotactics**: "Is there a word like *snaf* in your language?"

**Grammar**: "What would you say if there was more than one *snaf*?" "Could you say *snafs*?"<br><br>
...
Chelliah, Shobana. 2013. Fieldwork for language description. In Robert J. Podesva and Devyani Sharma (eds.), *Research Methods in Linguistics*, 51-73. Cambridge: Cambridge University Press.

---

# Translation: Text Translation

After you have collected a text, you can work with speakers/signers of a language to work on transcribing and translating a text.<br><br>

Play back a small section of a recorded text. Ask your consultant to pronounce it again slowly and transcribe it together. Ask for how they would translate it as whole, then ask after the meaning of single words. The consultant may offer extra information about the context or words within a text - these insights are often incredibly valuable.<br><br>
...
These are perhaps better termed *acceptability* judgements, as any judgement necessarily involves pragmatic acceptability.<br><br>
...
Schütze, Carson T. and Jon Sprouse. 2013. Judgment data. In Robert J. Podesva and Devyani Sharma (eds.), *Research Methods in Linguistics*, 27-50. Cambridge: Cambridge University Press.
...
If doing language description, there are a lot of typological questionnaires out there which can give you advice on which grammatical features to try to elicit. A classic is Comrie and Smith 1977. More questionnaires can be found on [TulQuest](http://tulquest.huma-num.fr/).
...
More naturalistic data can be collected if you ask a speaker to tell a story. This can be useful for finding structures you may not have otherwise found through questionnaire-based techniques, which can then be used for further testing.<br><br>
...
###Personal narratives
"Could you introduce yourself?" "Tell me about a recent hunting trip."

###Historical narratives
"Could you tell me about the history of your tribe?"

###Folktales
"Do you know a story about the boogeyman?"

###Procedural texts
"Can you tell me how to weave a basket?"

---

# Stimuli for Narratives

###Phonetics and Phonology
North Wind and the Sun

###Argument Structure
Cut and Break (Bohnemeyer et al. 2001), Put Project (Bowerman et al. 2004)

###Motion
Frog Story (Berman & Slobin 1994)

###Discourse Structure
Pear Story (Chafe 1980), The Jackal and the Crow (Carroll, Kelly and Gawne 2011), Family Problems (Carroll et al. 2011; San Roque et al. 2012)
...
Berman, R.A. & Dan I. Slobin. 1994. *Different ways of relating events in narrative*. Erlbaum.

Bowerman, M., Gullberg, M., Majid, A., & Narasimhan, B. (2004). Put project: The cross-linguistic encoding of placement events. In A. Majid (Ed.), *Field Manual Volume 9*, 10-24. Nijmegen: Max Planck Institute for Psycholinguistics. doi:10.17617/2.492916.
...
San Roque, Lila, Lauren Gawne, Darja Hoenigman, Julia Colleen Miller, Alan Rumsey, Stef Spronck, Alice Carroll and Nicholas Evans. 2012. Getting the Story Straight: Language Fieldwork Using a Narrative Problem-Solving Task. *Language Documentation & Conservation* 6, 135-174.
...
Cameron, Deborah, Elizabeth Frazer, Penelope Harvey, M. B. H. Rampton, and Kay Richardson. 2018. *Researching language: Issues of power and method*. London: Routledge.
