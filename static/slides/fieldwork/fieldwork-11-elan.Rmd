...
Minimally, names should make it obvious to anyone accessing the file which tier contains what type of data and who produced what.

.center[
##datatype@participant
]

<!-- insert table from slide 49 -->
